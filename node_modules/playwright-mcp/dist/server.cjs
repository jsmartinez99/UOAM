...
var initRecording = async (page2, onBrowserEvent) => {
  page2.addInitScript(() => {
    ...
    function handleKeyDown(event) {
      ...
      if (_optionalChain([document, 'access', _ => _.activeElement, 'optionalAccess', _2 => _2.tagName, 'access', _3 => _3.toLowerCase, 'call', _4 => _4()]) === "input") {
        if (event.key === "Tab") {
          window.recordKeyPress(dom, [event.key]);
        }
        return;
      }
      if (_optionalChain([document, 'access', _5 => _5.activeElement, 'optionalAccess', _6 => _6.tagName, 'access', _7 => _7.toLowerCase, 'call', _8 => _8()]) === "textarea") {
        return;
      }
      const keys = [];
    ...
    function handleKeyUp(event) {
      ...
      if (_optionalChain([document, 'access', _9 => _9.activeElement, 'optionalAccess', _10 => _10.tagName, 'access', _11 => _11.toLowerCase, 'call', _12 => _12()]) !== "input" && _optionalChain([document, 'access', _13 => _13.activeElement, 'optionalAccess', _14 => _14.tagName, 'access', _15 => _15.toLowerCase, 'call', _16 => _16()]) !== "textarea") {
        return;
      }
      const dom = getDom();
      window.recordInput(
...
var parseDom = (html) => {
  const dom = new (0, _jsdom.JSDOM)(html, {
...
var extractText = (element) => {
  if (element.childNodes.length === 0) {
    return _optionalChain([element, 'access', _17 => _17.textContent, 'optionalAccess', _18 => _18.trim, 'call', _19 => _19()]) || "";
  }
...
var extractTextsFromSiblings = (element) => {
  const siblings = Array.from(_optionalChain([element, 'access', _20 => _20.parentElement, 'optionalAccess', _21 => _21.childNodes]) || []);
...
var getElementName = (element) => {
  ...
  for (const attr of priorityAttrs) {
    if (!text) {
      text = _optionalChain([element, 'optionalAccess', _22 => _22.getAttribute, 'call', _23 => _23(attr)]) || "";
    }
  }
  if (!text) {
...
var getElementType = (element) => {
  const tagName = _optionalChain([element, 'optionalAccess', _24 => _24.tagName, 'access', _25 => _25.toLowerCase, 'call', _26 => _26()]);
...
server.tool(
  ...
  {
    selectors: _zod.z.array(_zod.z.string())
  },
  async ({ selectors }) => {
