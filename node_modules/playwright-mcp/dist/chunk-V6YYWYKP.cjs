...
var injectDiscordButton = () => {
  window.addEventListener("DOMContentLoaded", function() {
    ...
    const createDiscordButton = () => {
            ...
            <div style="display: flex; align-items: flex-start; gap: 12px;">
              ...
              <div style="flex: 1; min-width: 0;">
                <div style="font-weight: bold; font-size: 14px; margin-bottom: 6px;">
                  \u{1F389} Join Discord Community
                </div>
                <div style="font-size: 12px; opacity: 0.95; line-height: 1.4;">
                  <div style="margin-bottom: 2px;">\u{1F48E} <span style="font-weight: 600;">Get Premium FREE</span></div>
                  <div style="margin-bottom: 2px;">\u{1F41B} Debug help & tutorials</div>
                  <div>\u{1F91D} Share workflows & tips</div>
                </div>
              </div>
            </div>
          </a>
      ...
      const card = container.querySelector(".mcp-discord-card");
...
exports.injectDiscordButton = injectDiscordButton;
